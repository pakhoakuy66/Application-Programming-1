...
namespace Pathfinding
{
    public class AstarProfiler
    {
        ...
        static readonly Dictionary<string, ProfilePoint> profiles =
            new Dictionary<string, ProfilePoint>();
        ...
        public static void EndProfile(string tag)
        {
            ...
            {
                Debug.LogError(
                    "Can only end profiling for a tag which has already been started (tag was "
                        + tag
                        + ")"
                );
                return;
        ...
        public static void PrintFastResults()
        {
            ...
            double avgOverhead =
                fastProfiles[fastProfiles.Length - 2].watch.Elapsed.TotalMilliseconds / 1000.0;
            ...
            for (int i = 0; i < fastProfiles.Length; i++)
            {
                ...
                output
                    .Append(totalTime.ToString("0.0 ").PadLeft(10))
                    .Append(value.watch.Elapsed.TotalMilliseconds.ToString("(0.0)").PadLeft(10))
                    .Append("|   ");
        ...
        public static void PrintResults()
        {
            ...
            output
                .Append(" Name ".PadRight(maxLength))
                .Append("|")
                .Append(" Total Time	".PadRight(20))
                .Append("|")

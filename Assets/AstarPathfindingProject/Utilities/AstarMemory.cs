...
namespace Pathfinding.Util
{
    ...
    public static class Memory
    {
        ...
        public static void MemSet<T>(T[] array, T value, int byteSize)
            where T : struct
        {
            if (array == null)
            {
            ...
            while (index < length)
            {
                Buffer.BlockCopy(
                    ...
                    array,
                    index * byteSize,
                    Math.Min(block, length - index) * byteSize
                );
                index += block;
                block *= 2;
            }
        ...
        public static void MemSet<T>(T[] array, T value, int totalSize, int byteSize)
            where T : struct
        {
            if (array == null)
            {
            ...
            while (index < length)
            {
                Buffer.BlockCopy(
                    ...
                    array,
                    index * byteSize,
                    Math.Min(block, totalSize - index) * byteSize
                );
                index += block;
                block *= 2;
            }

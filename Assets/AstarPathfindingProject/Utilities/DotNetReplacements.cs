namespace Pathfinding.Util
{
    ...
    public struct Guid
    {
            ...
            for (; counter < 16; i++)
            {
                ...
                if (value == -1)
                    throw new System.FormatException(
                        "Invalid Guid format : " + c + " is not a hexadecimal character"
                    );
        ...
        public byte[] ToByteArray()
        {
            ...
            byte[] ba = System.BitConverter.GetBytes(
                !System.BitConverter.IsLittleEndian ? SwapEndianness(_a) : _a
            );
            byte[] bb = System.BitConverter.GetBytes(
                !System.BitConverter.IsLittleEndian ? SwapEndianness(_b) : _b
            );

...
namespace Pathfinding
{
    ...
    public class TriangleMeshNode : MeshNode
    {
        ...
        {
            return GetNavmeshHolder(GraphIndex)
                .GetVertexArrayIndex(i == 0 ? v0 : (i == 1 ? v1 : v2));
        }
        ...
        public override Vector3 ClosestPointOnNode(Vector3 p)
        {
            ...
            GetVertices(out a, out b, out c);
            return Pathfinding.Polygon.ClosestPointOnTriangle(
                (Vector3)a,
                (Vector3)b,
                (Vector3)c,
                p
        ...
        internal Int3 ClosestPointOnNodeXZInGraphSpace(Vector3 p)
        {
            ...
            var closest = Pathfinding.Polygon.ClosestPointOnTriangleXZ(
                (Vector3)a,
                (Vector3)b,
                (Vector3)c,
                p
        ...
        {
            return ContainsPointInGraphSpace(
                (Int3)GetNavmeshHolder(GraphIndex).transform.InverseTransform(p)
            );
        }
        ...
        public override bool ContainsPointInGraphSpace(Int3 p)
        {
            ...
            if ((long)(b.x - a.x) * (long)(p.z - a.z) - (long)(p.x - a.x) * (long)(b.z - a.z) > 0)
                return false;

            if ((long)(c.x - b.x) * (long)(p.z - b.z) - (long)(p.x - b.x) * (long)(c.z - b.z) > 0)
                return false;

            if ((long)(a.x - c.x) * (long)(p.z - c.z) - (long)(p.x - c.x) * (long)(a.z - c.z) > 0)
                return false;
        ...
        )
        {
            ...
            // Get tile indices
            int tileIndex1 =
                (GetVertexIndex(0) >> NavmeshBase.TileIndexOffset) & NavmeshBase.TileIndexMask;
            int tileIndex2 =
                (toTriNode.GetVertexIndex(0) >> NavmeshBase.TileIndexOffset)
                & NavmeshBase.TileIndexMask;
        ...
        public override float SurfaceArea()
        {
            ...
            return System.Math.Abs(
                    VectorMath.SignedTriangleAreaTimes2XZ(
                        holder.GetVertex(v0),
                        holder.GetVertex(v1),
                        holder.GetVertex(v2)
                    )
        ...
        public override Vector3 RandomPointOnSurface()
        {
            ...
            return ((Vector3)(holder.GetVertex(v1) - holder.GetVertex(v0))) * r1
                + ((Vector3)(holder.GetVertex(v2) - holder.GetVertex(v0))) * r2
                + (Vector3)holder.GetVertex(v0);
        }

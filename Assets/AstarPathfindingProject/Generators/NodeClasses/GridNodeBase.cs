    ...
    public abstract class GridNodeBase : GraphNode
    {
        ...
        public bool WalkableErosion
        {
            ...
            set
            {
                ...
                {
                    gridFlags = (ushort)(
                        gridFlags & ~GridFlagsWalkableErosionMask
        ...
        public bool TmpWalkable
        {
            ...
            set
            {
                ...
                {
                    gridFlags = (ushort)(
                        gridFlags & ~GridFlagsWalkableTmpMask
        ...
        public override Vector3 RandomPointOnSurface()
        {
            ...
            return gg.transform.Transform(
                graphSpacePosition + new Vector3(Random.value - 0.5f, 0, Random.value - 0.5f)
            );
        }

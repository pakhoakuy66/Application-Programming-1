...
namespace Pathfinding.Serialization
{
    ...
    public class GraphSerializationContext
    {
        ...
        public GraphNode DeserializeNodeReference()
        {
            ...
            if (id2NodeMapping == null)
                throw new Exception(
                    "Calling DeserializeNodeReference when not deserializing node references"
                );
        ...
        public UnityEngine.Object DeserializeUnityObject()
        {
            ...
            if (!string.IsNullOrEmpty(guid))
            {
                UnityReferenceHelper[] helpers =
                    UnityEngine.Object.FindObjectsOfType(typeof(UnityReferenceHelper))
                    as UnityReferenceHelper[];
    ...
    public class AstarSerializer
    {
        ...
        public void SerializeGraphs(NavGraph[] _graphs)
        {
            ...
            if (zip == null)
                throw new NullReferenceException(
                    "You must not call CloseSerialize before a call to this function"
                );
        ...
        NavGraph DeserializeGraph(int zipIndex, int graphIndex, System.Type[] availableGraphTypes)
        {
            ...
            if (ContainsEntry(jsonName))
            {
                ...
                TinyJsonDeserializer.Deserialize(
                    GetString(GetEntry(jsonName)),
                    graphType,
                    graph,
                    contextRoot
                );
        ...
        {
            return TinyJsonDeserializer.Deserialize(GetString(entry), typeof(GraphMeta))
                as GraphMeta;
        }
    ...
    public class GraphMeta
    {
        ...
        public Type GetGraphType(int index, System.Type[] availableGraphTypes)
        {
            ...
            throw new Exception(
                "No graph of type '" + typeNames[index] + "' could be created, type does not exist"
            );
        }
    }
    ...
    public class SerializeSettings
    {
        ...
        {
            get { return new SerializeSettings { nodes = false }; }
        }
    }
}

...
namespace Pathfinding
{
    ...
    public class AILerp : VersionedMonoBehaviour, IAstarAI
    {
        ...
        public bool canSearch
        {
            ...
            set
            {
                this.autoRepath.mode = value
                    ? AutoRepathPolicy.Mode.EveryNSeconds
        ...
        public bool reachedDestination
        {
            get
            {
                ...
                if (remainingDistance + dir.magnitude >= 0.05f)
                    return false;
        ...
        Vector3 IAstarAI.steeringTarget
        {
            get
            {
                ...
                return interpolator.valid
                    ? interpolator.position + interpolator.tangent
                    : simulatedPosition;
            }
        }
        #endregion
        ...
        {
            bool reachedEndOfPreviousPath =
                interpolator.valid && interpolator.remainingDistance < 0.0001f;

            if (interpolator.valid && !reachedEndOfPreviousPath)
            {
                previousMovementOrigin = interpolator.position;
                previousMovementDirection =
                    interpolator.tangent.normalized * interpolator.remainingDistance;
        ...
        protected virtual void ConfigureNewPath()
        {
            ...
            {
                var correctionFactor = Mathf.Max(
                    -Vector3.Dot(prevTangent.normalized, interpolator.tangent.normalized),
                    0
                );
                interpolator.distance -=
                    speed * correctionFactor * (1f / switchPathInterpolationSpeed);
            }
        }
        ...
        protected virtual Vector3 CalculateNextPosition(out Vector3 direction, float deltaTime)
        {
            ...
            if (interpolatePathSwitches && alpha < 1f)
            {
                ...
                Vector3 positionAlongPreviousPath =

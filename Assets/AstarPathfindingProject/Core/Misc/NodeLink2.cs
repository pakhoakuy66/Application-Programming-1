...
namespace Pathfinding
{
    ...
    public class NodeLink2 : GraphModifier
    {
        protected static Dictionary<GraphNode, NodeLink2> reference =
            new Dictionary<GraphNode, NodeLink2>();
        ...
        public void InternalOnPostScan()
        {
            ...
            throw new System.Exception(
                "Point graph is not included. Check your A* optimization settings."
            );
#else
        ...
        public void Apply(bool forceNewCheck)
        {
            ...
            connectedNode1.AddConnection(
                ...
                (uint)
                    Mathf.RoundToInt(
                        ((Int3)(clamped1 - StartTransform.position)).costMagnitude * costFactor
                    )
            );
            if (!oneWay)
                connectedNode2.AddConnection(
                    ...
                    (uint)
                        Mathf.RoundToInt(
                            ((Int3)(clamped2 - EndTransform.position)).costMagnitude * costFactor
                        )
                );
        ...
        internal static void SerializeReferences(
        ...
        internal static void DeserializeReferences(
            Pathfinding.Serialization.GraphSerializationContext ctx
        )
        {

    ...
    public class BinaryHeap
    {
        ...
        void DecreaseKey(Tuple node, ushort index)
        {
            ...
            while (bubbleIndex != 0)
            {
                ...
                if (
                    nodeF < heap[parentIndex].F
                    || (
                        SortGScores
                        && nodeF == heap[parentIndex].F
                        && nodeG > heap[parentIndex].node.G
                    )
                )
                {
            ...
            while (true)
            {
                ...
                if (pd <= numberOfItems)
                {
                    ...
                    if (
                        ...
                        && (
                            f0 < swapF
                            || (SortGScores && f0 == swapF && heap[pd + 0].node.G < swapItemG)
                        )
                    )
                    {
                        swapF = f0;
                    ...
                    if (
                        ...
                        && (
                            ...
                            || (
                                ...
                                && f1 == swapF
                                && heap[pd + 1].node.G
                                    < (swapIndex == parent ? swapItemG : heap[swapIndex].node.G)
                            )
                        )
                    )
                    {
